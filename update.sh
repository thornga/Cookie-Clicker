...
xargs -I {} wget -P ./ "https://orteil.dashnet.org/cookieclicker/{}" < _miscList.txt
...
xargs -a snd/_sndList.txt -I{} wget -O snd/{} "https://orteil.dashnet.org/cookieclicker/snd/{}"
xargs -a loc/_locList.txt -I{} wget -O loc/{} "https://orteil.dashnet.org/cookieclicker/loc/{}"
xargs -a img/_imgList.txt -I{} wget -O img/{} "https://orteil.dashnet.org/cookieclicker/img/{}"
cd beta/
wget -O index.html -U "Mozilla/5.0" "https://orteil.dashnet.org/cookieclicker/beta/"
xargs -I {} wget -P ./ "https://orteil.dashnet.org/cookieclicker/beta/{}" < ../_miscList.txt
sed -i "s|ajax('/patreon/grab.php'|ajax('../grab.txt'|" main.js
...
xargs -a snd/_sndList.txt -I{} wget -O snd/{} "https://orteil.dashnet.org/cookieclicker/beta/snd/{}"
xargs -a loc/_locList.txt -I{} wget -O loc/{} "https://orteil.dashnet.org/cookieclicker/beta/loc/{}"
xargs -a img/_imgList.txt -I{} wget -O img/{} "https://orteil.dashnet.org/cookieclicker/beta/img/{}"
cd ../
